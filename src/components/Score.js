...
function Score({ bmi, bmiType,weightMeasure }) {
  ...
  return (
    ...
    <div className="score border border-dark mt-3 px-4 py-5" style={{ boxShadow: '0px 0px 10px black' }} >
      <h5 className="text-center mt-2 text-secondary">BMI Score</h5>
      <div className='score mt-2'>
        <div className='mt-3 ' style={{display:'flex', justifyContent:'center'}}>
          <h2 style={{display:'inline',backgroundColor: 'rgb(132, 251, 255)',padding:'10px 10px 10px 10px', fontSize: '50px',fontWeight:'bolder'}} >{bmi}</h2>
        </div>
